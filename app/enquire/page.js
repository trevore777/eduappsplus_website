...
export const metadata = {
  title: "Discuss Your App Idea",
  description: "Tell EDU Apps Plus about your app idea, workflow problem or existing software project. Start a conversation about custom app and software development.",
...
export default function EnquirePage(){
  return <>
    <header className="siteHeader compactHeader"><div className="wrap">
      <div className="top"><Link className="brand" href="/">EDU APPS+</Link><nav className="mainNav"><Link href="/app-development">App Development</Link><Link href="/education-apps">Education Apps</Link><Link href="/small-business-apps">Small Business Apps</Link><Link href="/case-studies">Our Work</Link><Link className="navCta" href="/enquire">Start a Project</Link></nav></div>
      <div className="hero caseHero"><span className="eyebrow">Project enquiry</span><h1>Tell us what you want to build.</h1><p>You do not need a finished specification. Start with the problem, workflow or idea and the technical details can be worked out from there.</p></div>
    </div></header>
