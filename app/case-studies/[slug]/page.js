...
export default async function CaseStudyPage({ params }) {
  ...
  return <>
    ...
    <main><div className="wrap narrow">
      ...
      <section className="ctaPanel"><div><span className="eyebrow">Your project</span><h2>Could an app solve a problem for you?</h2><p>Send through the idea or workflow you would like to improve. It can be an early concept or an existing application that needs work.</p></div><Link className="primaryButton" href={`/enquire?caseStudy=${encodeURIComponent(study.name)}`}>Send an Enquiry</Link></section>
