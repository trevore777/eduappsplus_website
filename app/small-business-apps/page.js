...
export default function SmallBusinessAppsPage() {
  return <>
    <header className="siteHeader"><div className="wrap">
      <div className="top"><Link className="brand" href="/">EDU APPS+</Link><nav className="mainNav"><Link href="/app-development">App Development</Link><Link href="/education-apps">Education Apps</Link><Link href="/guides">Guides</Link><Link href="/case-studies">Our Work</Link><Link className="navCta" href="/enquire">Start a Project</Link></nav></div>
    ...
    <main>
      ...
      <section className="commercialSection"><div className="wrap"><span className="eyebrow dark">Business software guides</span><h2 className="largeHeading">Plan the next step before you build.</h2><div className="serviceGrid">
        <div className="serviceCard"><h3>Can Custom Software Replace My Spreadsheets?</h3><p>See when a spreadsheet-based process has grown into something better handled by a database-backed application.</p><Link className="textLink" href="/replace-spreadsheets-with-software">Read the spreadsheet guide →</Link></div>
        <div className="serviceCard"><h3>How Much Does a Small Business App Cost?</h3><p>Understand the factors that affect development scope, complexity, integrations and ongoing costs.</p><Link className="textLink" href="/small-business-app-cost">Read the cost guide →</Link></div>
        <div className="serviceCard"><h3>How Can AI Be Added to My Business App?</h3><p>Explore practical AI features for summaries, extraction, classification, drafting and workflow support.</p><Link className="textLink" href="/ai-for-business-apps">Explore AI integration →</Link></div>
    ...
    <footer>EDU Apps Plus · Small Business Software · Gold Coast · <Link href="/guides">Guides</Link> · <Link href="/">Home</Link></footer>
  </>;
}
